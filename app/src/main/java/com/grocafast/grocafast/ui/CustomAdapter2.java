...
public class CustomAdapter2 extends ArrayAdapter<DataList> implements View.OnClickListener{
    ...
    public CustomAdapter2(ArrayList<DataList> data, Context context) {
